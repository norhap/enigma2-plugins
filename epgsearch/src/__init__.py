...
config.plugins.epgsearch.filter_type = ConfigSelection(default="exact", choices=[("partial", _("partial match")), ("exact", _("exact match")), ("exact_whole", _("full match (short + extended)"))])
...
config.plugins.epgsearch.yellow_eventname = ConfigYesNo(default=False)
