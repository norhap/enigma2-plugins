...
SKIN = """
	<screen flags="wfNoBorder" position="30,30" size="600,460" title="Audio Sync" zPosition="1" backgroundColor="#ff000000">
		...
		<widget name="key_green" position="315,15" zPosition="4" size="85,20" font="Regular;14" verticalAlignment="center" horizontalAlignment="left" backgroundColor="#232323" foregroundColor="#ffffff" transparent="1"/>
		<widget name="key_red" position="315,40" zPosition="4" size="85,20" font="Regular;14" verticalAlignment="center" horizontalAlignment="left" backgroundColor="#232323" foregroundColor="#ffffff" transparent="1"/>
		<widget name="key_yellow" position="425,15" zPosition="4" size="160,20" font="Regular;14" verticalAlignment="center" horizontalAlignment="left" backgroundColor="#232323" foregroundColor="#ffffff" transparent="1" />
		<widget name="key_blue" position="425,40" zPosition="4" size="160,20" font="Regular;14" verticalAlignment="center" horizontalAlignment="left" backgroundColor="#232323" foregroundColor="#ffffff" transparent="1" />
	</screen>"""
