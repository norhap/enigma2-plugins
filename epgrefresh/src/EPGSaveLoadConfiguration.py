...
class EPGSaveLoadConfiguration(Screen, ConfigListScreen):
	if HD:
		skin = """<screen name="EPGSaveLoadConfiguration" position="center,center" size="600,640">
			...
			<widget source="epgcachelocation" render="Label" position="5,495" size="590,50" zPosition="1" font="Regular;21" horizontalAlignment="left" verticalAlignment="center" />
		...
		skin = """<screen name="EPGSaveLoadConfiguration" position="center,center" size="600,520">
			...
			<widget source="key_red" render="Label" position="0,5" zPosition="1" size="140,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
			<widget source="key_green" render="Label" position="140,5" zPosition="1" size="140,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
			<widget source="epgcachelocation" render="Label" position="5,375" size="590,50" zPosition="1" font="Regular;21" horizontalAlignment="left" verticalAlignment="center" />
